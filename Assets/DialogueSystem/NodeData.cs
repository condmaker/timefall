...
namespace DialogueSystem
{
    ...
    public class NodeData
    {
        ...
        /// <summary>
        /// Property that defines the position of this Node on hte GraphView
        /// </summary>
        ...
        /// </summary>
        [SerializeField]
        private List<OutportData> outPorts = new List<OutportData>();

        /// <summary>
        /// Property that defines the list of Choice data connected to
        /// the ouput ports of the Node
        /// </summary>
        public List<OutportData> OutPorts => outPorts;
